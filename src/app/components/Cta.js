                ...
                <div className="container">
                    <div className="w-ful border-b border-[#414651] pb-10 lg:pb-[62px]">
                        <div className="text-start xl:grid xl:items-center xl:grid-cols-12">
                            ...
                            <Link href="/contact" className="relative xl:col-span-3 w-fit ml-auto group anim overflow-hidden anim bg-white rounded-[4px] py-2.5 px-3 lg:py-3.5 lg:px-5 font-medium text-black text-sm lg:text-lg inline-flex items-center gap-x-4">Find My Revenue Leaks<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
