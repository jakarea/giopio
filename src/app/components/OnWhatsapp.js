    ...
    return (
        <>
            <div className="flex xl:inline-flex gap-y-4 flex-col xl:flex-row bg-[#2C4855] p-4 rounded-lg xl:rounded-full items-center gap-x-[14px] xl:pl-[32px] relative z-50 !font-jakarta anim dark:bg-[#2B2C42]">
                ...
                <Link target='_blank' href="https://api.whatsapp.com/send/?phone=880 1728 247 398&text&type=phone_number&app_absent=0" className="group flex xl:inline-flex w-full xl:w-auto items-center justify-center bg-[#00CD62] h-[50px] lg:h-[68px] px-[18px] rounded-full text-base xl:text-2xl font-medium text-new hover:text-[#26404C] dark:text-[#26404C] dark:hover:text-opacity-80">
                    <Image
